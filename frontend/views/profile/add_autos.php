...
<section class="cabinet">
  ...
  <div class="tab-content">
    <div id="home" <?=($active == 1)?'class="tab-pane in active"':'class="tab-pane fade"'?>>
           <div id="create_autos" <?=($active != 1)?'style="display: none;"':''?>>
             <div class="row">
              <div class="col-sm-6">
               ...
               <div class="col-sm-6">
                 <?= $form->field($transport, 'registration_number')->widget(\yii\widgets\MaskedInput::className(),['mask' => '9','clientOptions' => ['repeat' => 10, 'greedy' => false],'options'=>['class'=>'my_input','placeholder'=>$transport->getAttributeLabel('registration_number')]])->label(false) ?>
               </div>
              </div>
    ...
    <div id="menu1" <?=($active == 2)?'class="tab-pane in active"':'class="tab-pane fade"'?>>
        <div id="create_driver" <?=($active != 2)?'style="display: none;"':''?>>
                  <div class="row">
                    <div class="col-sm-6">
