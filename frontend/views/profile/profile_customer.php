      ...
      <div class="cabinet_left">
        ...
        <div class="tab-content input_styles cab_st">
          ...
          <div class="row hdr_svgs">
            <div class="col-md-3">
                <?=Html::a('  <span class="aft_back"></span>
                ...
                <span>'.Yii::t('app','Passenger Transportation'), ['task/create-passengers'],['data-pjax'=>0,'title'=> Yii::t('app','Add'), 'class'=>'enter_to_site'])?>
            </div>
            <div class="col-md-3">
              <?=Html::a('<span class="aft_back"></span>
                ...
                <span>'.Yii::t('app','Freight transportation'), ['task/create-goods'],['data-pjax'=>0,'title'=> Yii::t('app','Add'), 'class'=>'enter_to_site'])?>
            </div>
            <div class="col-md-3">
              <?=Html::a('<span class="aft_back"></span>
                ...
                <span>'.Yii::t('app','Transportation of cars and equipment'), ['task/create-vehicles'],['data-pjax'=>0,'title'=> Yii::t('app','Add'), 'class'=>'enter_to_site'])?>
            </div>
            <div class="col-md-3">
               <?=Html::a('<span class="aft_back"></span>
                ...
                <span>'.Yii::t('app','Relocation assistance'), ['task/create-help'],['data-pjax'=>0,'title'=> Yii::t('app','Add'), 'class'=>'enter_to_site'])?>
            </div>
          </div>
          </div>
