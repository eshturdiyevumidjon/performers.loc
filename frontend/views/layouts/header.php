      ...
      <div class="d-flex justify-content-between align-items-center">
       ...
       <p class="create_equ"><?=Yii::t('app','Create Task')?></p>
          <div class="row hdr_svgs">
            <div class="col-md-3">
              <a href="/task/create-passengers" class="enter_to_site">
            ...
            <div class="col-md-3">
              <a href="/task/create-goods" class="enter_to_site">
                <span class="aft_back"></span>
            ...
            <div class="col-md-3">
              <a href="/task/create-vehicles" class="enter_to_site">
                <span class="aft_back"></span>
            ...
            <div class="col-md-3">
              <a href="/task/create-help" class="enter_to_site">
                <span class="aft_back"></span>
