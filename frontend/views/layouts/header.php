...
<header <?= ( $pathInfo == 'site/index' || $pathInfo == "" ) ? 'class="fixed_header"':'' ?>>
  <div class="container">
    <div class="d-flex justify-content-between align-items-center hdr_top">
      ...
      <?php if($user->isGuest):?>
      <!--  <a href="/site/login" class="enter_to_site" role='modal-remote'><span class="aft_back"></span><?=Yii::t('app','Login / Register')?></a> -->
