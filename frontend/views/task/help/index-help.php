...
$this->title = Yii::t('app','Relocation assistance');
...
<div class="tasks-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columns-help.php'),
            'toolbar'=> [
                        ['content'=>
                            '<div style="margin-top:10px;">'.Html::a(Yii::t('app','Add').'<i class="glyphicon glyphicon-plus"></i>', ['create-help'],
