  ...
  <div class="container">
    ...
    <div class="order_wrapper">
      ...
      <form action="#" class="input_styles">
        <div class="row">
          <div class="col-md-6 order_left"> 
            ...
            <div class="form-group">
                <input type="text" placeholder="Адрес отгрузки" class="otp_punkt">
            </div>
            <hr>
            <div class="form-group">
                <input type="text" placeholder="Адрес доставки" class="otp_punkt2">
            </div>
            ...
            <div class="form-group">
                <input type="date" placeholder="Дата начала срока задания" class="other_date_inp">
                <p class="opac d_mob_none">Начальная дата и время когда груз будет готов к отправке</p>
            </div>
            <div class="form-group">
                <input type="date" placeholder="Дата окончания срока задания" class="other_date_inp">
        ...
        <h4 class="mb15">Загрузить фото</h4>
        <div class="lert">
          <div class="download_photos added">
            <img src="/images/girll.jpg" alt="">
            <button class="remove_photo"><img src="/images/minus_a.svg" alt=""></button>
            <button class="add_photo"><img src="/images/plus_a.svg" alt=""></button>
          </div>
